...
from dto.get_info import GetInfoRequest, GetInfoResponse
...
from dto.process_content import ProcessContentRequest, ProcessContentResponse
...
@app.post("/get-info", response_model=GetInfoResponse)
